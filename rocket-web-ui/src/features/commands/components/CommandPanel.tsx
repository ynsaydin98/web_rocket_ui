...
import { RoketTelemetriCommandPanel } from "../../telemetry/components/RoketTelemetriCommandPanel";
...
export function CommandPanel() {
  ...
  return (
    <div className="command-layout">
      <Panel title="Roket Telemetri Komutları" eyebrow="Komut Konsolu">
        <RoketTelemetriCommandPanel />
      </Panel>
      <Panel
        title="Son Komut"
