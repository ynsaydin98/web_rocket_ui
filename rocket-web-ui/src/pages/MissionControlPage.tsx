...
import {
  startMissionControlSimulation,
  stopMissionControlSimulation,
} from "../features/missionControl/services/missionControlSimulationLoop";
...
export function MissionControlPage() {
  ...
  useEffect(() => {
    startMissionControlSimulation();
    return () => stopMissionControlSimulation();
  }, []);
