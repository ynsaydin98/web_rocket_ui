...
// by the real itkiOpMod value coming over the WebSocket telemetry pipeline.
...
/**
 * Real mission phase, driven by the itkiOpMod code on the test-stand
 * telemetry packet (see mapItkiOpMod in missionControlTelemetryMapper.ts).
